...
public class GridBagPanel extends JPanel {
     ...
     *
     * @param filename the name of XML file that describes the pane's components and their positions
     */
    public GridBagPanel(File filename) {
        ...
        try {
            ...
            if (filename.toString().contains("-schema")) {
     ...
     * @return the component with the given name, or null if no component iin this grid bag pane has the given name
     */
    ...
    private void parseCell(Element e, int r, int c) {
        ...
        // user reflection to get integer values of static fields
    ...
    private Object parseBean(Element e) {
        try {
            ...
            for (int i = 1; i < children.getLength(); i++) {
                ...
                boolean done = false;
                for (int j = 0; !done && j < descriptors.length; i++) {
